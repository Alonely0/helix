...
pub fn default() -> HashMap<Mode, KeyTrie> {
    let normal = keymap!({ "Normal mode"
        ...
        "e" | "down" => move_visual_line_down,
        "i" | "up" => move_visual_line_up,
        ...
        "space" => { "Space"
            ...
            "w" => { "Window"
                ...
                "r" => { "Window resize mode" sticky=true
                    "n" | "left" => shrink_view_width,
                    "e" | "right" => grow_view_width,
                    "i" | "down" => shrink_view_height,
                    "o" | "up" => grow_view_height,
                },
                "f" => goto_file_hsplit,
                "F" => goto_file_vsplit,
                "C-q" | "q" => wclose,
                "C-A-o" | "A-o" => wonly,
                "C-n" | "n" | "left" => jump_view_left,
                "C-e" | "e" | "down" => jump_view_down,
                "C-i" | "i" | "up" => jump_view_up,
                "C-o" | "o" | "right" => jump_view_right,
                "N" => swap_view_left,
                "E" => swap_view_down,
                "I" => swap_view_up,
                "O" => swap_view_right,
                "k" => { "New split scratch buffer"
                    "C-s" | "s" => hsplit_new,
                    "C-v" | "v" => vsplit_new,
                },
            },
    ...
    select.merge_nodes(keymap!({ "Select mode"
        ...
        "e" | "down" => extend_visual_line_down,
        "i" | "up" => extend_visual_line_up,
